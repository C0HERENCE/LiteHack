...
uint64 Dec::ulevel(uint64 ptr)
{
	...
	LODWORD(v20) = __ROR4__(~__ROR4__((uint32)ptr, 16) + 553745679, 16) ^ 0xDEFE82F0;
...
uint64 Dec::gameinstance(uint64 ptr)
{
	...
	LODWORD(v3) = __ROL4__(__ROL4__((uint32)ptr + 511116221, 16) + 852523252, 16) ^ 0x79597537;
...
uint64 Dec::actor(uint64 ptr)
{
	...
	LODWORD(v3) = (uint32)((ptr ^ 0x6888FC42) + 1301108050) ^ 0x7FFA56EC;
...
uint64 Dec::pawn(uint64 ptr)
{
	...
	LODWORD(v20) = (uint32)(ptr + 1273741253) ^ 0x4BEBBFC5;
...
{
	unsigned __int64 v7 = LiteHack.GMemory->Read64(ptr); // rcx
	...
	HIDWORD(v16) = (((unsigned __int16)__ROL2__(WORD1(v7), 8) << 16) | (unsigned __int16)__ROR2__((uint16)v7 ^ WORD1(v7), 8)) ^ 0x4DC34D83;
	return v16;
}
// ULocalPlayer
uint64 Dec::playercontroller(uint64 ptr)
{
	...
	LODWORD(v8) = __ROR4__(__ROR4__((uint32)ptr, 8) + 1736961001, 8) ^ 0x6787EBE9,
