...
public:
	...
	// AActor
	static const uint64 ComparisonIndex = 0x14;
	...
	static const uint64 AnimationKickMultiplier = 0x38 + 0x0074;
	static const uint64 RecoilMultiplierVertical = 0x38 + 0x0108;
	static const uint64 MultipleFiringBulletsSpread = 0x38 + 0x0018;
	static const uint64 SwayMultiplier = 0x38 + 0x0070;
